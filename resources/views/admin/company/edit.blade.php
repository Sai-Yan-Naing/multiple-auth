        ...
        <main>
            <div class="container-fluid px-4">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h2 class="mt-4 mb-4">Edit Company</h2>
                        <form action="{{ route('updateCompany',$company->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="form-group mb-2">
                                <label class="mb-2" for="name">Name:</label>
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Enter Company name" name="name" value="{{ old('name', $company->name) }}" autocomplete="name" autofocus>
                                @error('name')
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="Enter email" name="email" value="{{ old('email', $company->email) }}" autocomplete="email" autofocus>
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
